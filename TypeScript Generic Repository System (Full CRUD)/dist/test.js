...
const modelsRepo_1 = require("./modelsRepo");
async function test() {
    const userTest = new modelsRepo_1.UserRepo();
    const courseTest = new modelsRepo_1.CourseRepo();
    const bookingTest = new modelsRepo_1.BookingRepo();
    ...
    console.log("Filter users by name = Ali Updated:", await userTest.findItem({ name: "Ali Updated" }));
}
test();
